...
- 組み込み(C/C++)を軸に活動中。  
- アプリ開発(Android、Kotlin)も。
- 便利/時短ツール開発、AI/機械学習(python)も。  
- フロントは模索中。

## As a Gamer
😇全く上手くないが本人はまじめにやっているつもりらしい。

|Active|Game|Achievement|
|:---:|:---:|-----------|
|×|IdentityV😡|ソロ勇士×3|
|×|Blue Archive🥰|総力戦(INSANE)2桁×2 3桁×∞|
|×|艦これ&#x1f61a;|1~3群×∞|
|〇|Shadowverse🤓|RAGEプレーオフ×1 MPランキング2桁×3~4|
|〇|機動戦士ガンダムEXVS🐒|ソロAce 2200 5割|
